...
Given /^given there are contacts "(.*?)" and "(.*?)"$/ do |first_user, second_user|
  FactoryGirl.create(:contact, first_name: first_user, email: first_user + "@fakeemail.com")
  FactoryGirl.create(:contact, first_name: second_user, email: second_user + "@fakeemail.com")
end
